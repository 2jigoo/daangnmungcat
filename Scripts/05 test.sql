...
INSERT INTO MEMBER VALUES('admin', '1234', '관리자', '관리자', 'admin@admin.co.kr', '010-1234-1234', 3,  44, 1, NULL, NULL, sysdate);
INSERT INTO MEMBER VALUES('test', '1234', '테스트', '테스트닉', 'test@test.co.kr', '010-5656-5656', 3, 44, 1, NULL, NULL, sysdate);

SELECT * FROM MEMBER;
SELECT * FROM DONGNE2 WHERE DONGNE1_ID = 3;