...
$(document).ready(function(){
	...
	$('input[name=all]').on('change', function(){
		if ($('input[name=all]').is(':checked') == true){
			$('input[name=ok1]').prop("checked", true);	
			$('input[name=ok2]').prop("checked", true);	
		}else{
			$('input[name=ok1]').prop("checked", false)
			$('input[name=ok2]').prop("checked", false)
		}
	});
...
<div class="contract_div">
	<div style="width:70%; text-align:left;">
		<input type="checkbox" id="ok2" name="ok2">
    	<label for="ok2" class="all_b"></label>
    	<label for="ok2" class="all_c"><span style="color:#ff7e15; font-weight:500">(필수)</span> 개인정보취급방침   <a href="/service/policy" class="a">전체보기</a></label>
	</div>
...
당근멍캣('/daangnmungcat'이하 '당근멍캣')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 겨우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
...
① 당근멍캣은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.

② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.

1.홈페이지 회원가입 및 관리
홈페이지 회원가입 및 관리와 관련한 개인정보는 수집.이용에 관한 동의일로부터 5년까지 위 이용목적을 위하여 보유.이용됩니다.
보유근거 : 보유근거
...
① 당근멍캣은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

② 당근멍캣은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
...
① 당근멍캣은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

1.
위탁받는 자 (수탁자) :
위탁하는 업무의 내용 :
위탁기간 :
② 당근멍캣은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.
...
① 정보주체는 당근멍캣에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.

② 제1항에 따른 권리 행사는당근멍캣에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 당근멍캣은(는) 이에 대해 지체 없이 조치하겠습니다.
...
⑥ 당근멍캣은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.



제6조(처리하는 개인정보의 항목 작성)

① 당근멍캣은(는) 다음의 개인정보 항목을 처리하고 있습니다.
...
① 당근멍캣 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
...
1. 파기절차
당근멍캣 은(는) 파기 사유가 발생한 개인정보를 선정하고, 당근멍캣 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.



제8조(개인정보의 안전성 확보 조치)

당근멍캣은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
...
4. 해킹 등에 대비한 기술적 대책
당근멍캣('당근멍캣')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.
...
담당자 :
연락처 :, ,
② 정보주체께서는 당근멍캣 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 당근멍캣 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.

제11조(개인정보 열람청구)
정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.
당근멍캣은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
