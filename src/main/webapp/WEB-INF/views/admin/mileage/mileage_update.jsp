...
<div class="card shadow mb-4">
	<div class="card-header py-2">
		<h6 class=" font-weight-bold text-primary" style="font-size: 1.3em;">
			<div class="mt-2 float-left">마일리지 수정</div>
		</h6>
	</div>
	<!-- card-body -->
	<div class="card-body mall_adm_list">
		<div class="mall_pdt_write">
			<form name="mileWrite" action="/admin/mileage/update" method="post">
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" >
				<input type="hidden" id="id" name="id" value="${mileage.id}">
				<ul>
					<li>
						<p>주문번호</p>
						<div>
					...
					<li>
						<p>회원 아이디</p>
						<div>
							<input type="text" id="memId" name="member.id" value="${mileage.member.id}">
						</div>
					</li>
					<li>
						<p>적립 내용</p>
						<div>
							<input type="text" id="mileage_content" name="content" value="${mileage.content}">
						</div>
					</li>
					<li>
						<p>적립 금액</p>
